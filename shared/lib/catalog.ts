...
export function normalizeCategoryRecord(category: any) {
  return {
...
export function normalizeBrandRecord(brand: any) {
...
export function getProductPrimaryImage(product: any) {
...
export function normalizeHeroBannerRecord(banner: any) {
  return {
...
export function createCatalogStateFromSnapshot(snapshot: any = {}) {
  return {
...
export function getProductAvailability(product: any) {
  switch (product.status) {
    ...
    default:
      return { label: 'In Stock', tone: 'text-emerald-500', dot: 'bg-emerald-500' };
  }
}
...
export function createEmptyProductDraft(categories: any[] = [], brands: any[] = []) {
  return {
    id: '',
    name: '',
    brand: brands[0]?.name || '',
...
export function validateProductDraft(draft: any) {
...
export function validateHeroBannerDraft(draft: any) {
  const errors: Record<string, string> = {};
